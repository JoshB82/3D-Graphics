    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                ...
                case Keys.I:
                    // Rotate up
                    Matrix4x4 transformation_up = Transform.Rotate(scene.Render_Camera.World_Direction_Right, camera_tilt * update_time);
                ...
                case Keys.J:
                    // Rotate left
                    Matrix4x4 transformation_left = Transform.Rotate(scene.Render_Camera.World_Direction_Up, camera_tilt * update_time);
                ...
                case Keys.L:
                    // Rotate right
                    Matrix4x4 transformation_right = Transform.Rotate(scene.Render_Camera.World_Direction_Up, -camera_tilt * update_time);
                ...
                case Keys.K:
                    // Rotate down
                    Matrix4x4 transformation_down = Transform.Rotate(scene.Render_Camera.World_Direction_Right, -camera_tilt * update_time);
                ...
                case Keys.U:
                    // Roll left
                    Matrix4x4 transformation_roll_left = Transform.Rotate(scene.Render_Camera.World_Direction, -camera_tilt * update_time);
                ...
                case Keys.O:
                    // Roll right
                    Matrix4x4 transformation_roll_right = Transform.Rotate(scene.Render_Camera.World_Direction, camera_tilt * update_time);
